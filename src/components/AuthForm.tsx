...
export const AuthForm = ({
  ...
  return <div className="min-h-screen flex items-center justify-center p-4 bg-zinc-400">
      <Card className="w-full max-w-md glass-effect">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {isLogin ? 'Acesse sua conta para continuar' : 'Crie sua conta e comece sua jornada nutricional'}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full health-gradient text-white" disabled={loading}>
              {loading ? 'Carregando...' : isLogin ? 'Entrar' : 'Criar Conta'}
            </Button>
          </form>

          <div className="mt-4 text-center">
            <Button variant="link" onClick={() => setIsLogin(!isLogin)} className="text-green-600">
